...
FORWARD _PROTOTYPE( int shift_msg, (char *msg, int time) );
...
PRIVATE int s_transfer(
	...
	/* step 1 - if less than 0 bytes give a EOF */
	if(bytes <=0){
		return OK;
	}
	/* step 2 - if the size asked for is greater than our size*/
